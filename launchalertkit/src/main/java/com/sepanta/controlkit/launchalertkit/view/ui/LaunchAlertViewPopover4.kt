...
class LaunchAlertViewPopover4 : LaunchAlertViewContract {
            ...
            Column(
                ...
                Surface(
                    ...
                    Column(
                        ...
                        ButtonCancel(config, viewModel = viewModel, response = response)
                    }
                }
    ...
    private fun ButtonSubmit(
        ...
        config.submitButtonView?.let { button ->
            ...
            modifier = Modifier
                .padding(top = 48.dp)
                .size(height = 42.dp, width = 222.dp),
    ...
    private fun ButtonCancel(
        ...
        config.cancelButtonView?.let { button ->
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = config.cancelButtonColor ?: Transparent
            ),
